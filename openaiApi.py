...
# "file_text + "\ngenerate 10 multiple choice questions based on the information given above and after every question print the right answer like this Answer: X"
    ...
    for line in response_content.split("\n"):
        ...
        elif line.startswith(": ") or line.startswith("Answer:") or line.startswith("Отговор:") or line.startswith("Right answer: ") or line.startswith("Правилен отговор: ") or line.startswith("Correct Answer: "):
